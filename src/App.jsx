  ...
  return (
    <div className="site-shell">
      <header className="topbar">
        ...
        <a className="top-cta" href="http://127.0.0.1:3102/">Открыть приложение <ArrowUpRight /></a>
        ...
        <section className="hero" id="top">
          <div className="hero-copy">
            ...
            <motion.div className="hero-actions" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .7, delay: .4 }}>
              <a className="button button-primary" href="http://127.0.0.1:3102/">Попробовать N-Ice Loft <ArrowRight /></a>
